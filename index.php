...
if ($materials) {
    foreach($materials as $material) {
        ...
        $buttons = array();
        $buttons[] =  html_writer::link(new moodle_url('./edit.php', array('id'=>$material->id, 'categoryid'=>$course->category)), html_writer::empty_tag('img', array('src'=>$OUTPUT->pix_url('t/edit'), 'alt'=>get_string('edit'), 'class'=>'iconsmall')));
        $buttons[] =  html_writer::link(new moodle_url('./edit.php', array('id'=>$material->id, 'categoryid'=>$course->category, 'delete'=>1)), html_writer::empty_tag('img', array('src'=>$OUTPUT->pix_url('t/delete'), 'alt'=>get_string('delete'), 'class'=>'iconsmall')));
